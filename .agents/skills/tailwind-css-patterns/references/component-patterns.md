...
```html
<div class="max-w-sm mx-auto bg-white rounded-2xl shadow-lg overflow-hidden sm:flex sm:max-w-2xl">
  ...
  <div class="p-8">
    ...
    <button class="mt-4 px-4 py-2 bg-indigo-600 text-white rounded-2xl hover:bg-indigo-700 transition">
      Contact
    </button>
  </div>
</div>
...
<form class="space-y-6 max-w-md mx-auto">
  <div>
    ...
    <input
      type="email"
      class="w-full px-4 py-2 border border-gray-300 rounded-2xl focus:ring-2 focus:ring-blue-500 focus:border-transparent"
  ...
  <button
    type="submit"
    class="w-full bg-blue-600 text-white font-semibold py-2 px-4 rounded-2xl hover:bg-blue-700 transition"
  >
    Sign In
  </button>
</form>
